            ...
            if (marqueeRef.current) {
                ...
                const handleScroll = () => {
                    ...
                    loops.forEach(tl => {
                        ...
                        tl.progress(tl.progress() + (scrollDelta * 0.0005));
                    });
                    ...
                    scrollTimeout = setTimeout(() => {
                        // Stop the animation when scrolling stops
                        loops.forEach(tl => {
                            tl.pause();
                        });
                    }, 150); // Adjust this value to change how quickly it stops after scrolling
                };
...
export default MovingTextPaused;