    ...
    return (
        <div className={'icr-bg'}>
            ...
            <div className={'icr-content-lander'}>
                <div ref={textContentRef} className={'w-screen'}>
                    <div className={'flex justify-center w-[85%]'}>
                        <p className={'poppins-medium text-white text-[6rem] z-[13]'}>
                            Mango Sticky
                            Rice
                        </p>
                    </div>
            ...
            <div className={`icr-background-land`} >
                <div className={'flex'}>
                    ...
                    <img src={cone} ref={coneRef} className="cone-img w-[870px]"/>


                <div className={'content-icr'}>
                    <div
                        className={'bg-white w-[800px] h-[190px] rounded-[25px] flex pt-[25px] pb-[35px] pl-[35px] gap-[20px] mb-[20px] flex-col'}>
                        <p className={'text-[40px] poppins-medium font-extrabold text-[#3f2021]'}>Mango Sticky Rice</p>
                        <p className={'text-[#3f2021] text-[20px]'}>Mango and coconut sticky rice ice cream with mango
                            pieces, coconut shreds and a mango
                            swirl</p>
                    </div>
                    <div className={'flex flex-col gap-[20px]'}>
                        <div
                            className={`flex flex-col w-[800px] bg-white rounded-[25px] ${AllergyAns}? 'dropdown-content':'dropdown-content-expanded    ' `}>
                            <div
                                className={`flex justify-between w-[800px] bg-white rounded-[25px] ac h-[70px] pr-[25px] pl-[25px] `}>
                                <p className={'font-extrabold poppins-medium text-[1.3rem] text-[#3f2021] '}>Allergens</p>
                            ...
                            <div className={`faq-answer ${AllergyAns ? 'open' : ''}`}>
                                <div className={'text-[#3f2021] text-[1rem] ml-[25px] mb-[20px]'}>
                                    Milk
                                </div>
                            </div>
                        ...
                        <div
                            className={`flex flex-col w-[800px] bg-white rounded-[25px] ${ingredients}? 'dropdown-content':'dropdown-content-expanded    ' `}>
                            <div
                                className={`flex justify-between w-[800px] bg-white rounded-[25px] ac h-[70px] pr-[25px] pl-[25px] `}>
                                <p className={'font-extrabold poppins-medium text-[1.3rem] text-[#3f2021] '}>Ingredients</p>
                                <svg width="30" height="30" viewBox="0 0 24 24" fill="none"
                            ...
                            <div className={`faq-answer ${ingredients ? 'open' : ''}`}>
                                <div className={'text-[#3f2021] text-[1rem] ml-[25px] mb-[20px] mr-[25px]'}>
                    ...
                    <div className={'w-screen h-[200px] bg-white ml-[-115px] mt-[230px] rounded-t-[105px]'}></div>
                </div>
            </div>
